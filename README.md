...
3. Upload the png you want to transform in a badge by clicking on "choisir un fichier" under "Create your Badge".
...
- **checkNtpCircle()** <br>
Check the % of nontransparent pixels out of the desired circle using canvas and euclidian distance. An alert is displayed if some pixels are out of bound with the %.
...
- **displayAvatar()** <br>
Using canvas, a circular avatar is created with a brown border and displayed next to the input image.
